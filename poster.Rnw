...
\textcolor{i6bluedark}{\textbf{\large Other functionality}}
          ...
          \begin{column}{0.96\linewidth}
            \begin{description}
              ...
              \item[Invasive species : ] Check is a taxon is listed in the Global Invasive Species Database (GISD).  Integration of the Global Invasive Species Information Network (GISIN) is under development.
            \end{description}
